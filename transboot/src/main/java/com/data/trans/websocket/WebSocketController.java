package com.data.trans.websocket;
 ...
 * @Date 2018年3月25日
 * @author dnc
 * @Description 接受websocket客户端请求，必须为@Controller注解组件
 */
@Controller
public class WebSocketController {
	 ...
	 * 消息接受及返回交互方法：
	 * @MessageMapping 注解对应页面发送消息的参数一 stompClient.send("/myCmd", {}, JSON.stringify({'name': name}));
	 * @SendTo 注解对应客户端的订阅字符串（注意前缀为WebSocketConfig.registry.enableSimpleBroker("/myTopic");）中的"/myTopic"
	 */
